...
def create_model(trial):
    ...
    model = Sequential()
    model.add(GRU(nodes1, return_sequences=False, recurrent_regularizer='L2',input_shape=(401, 8)))
    # # model.add(GRU(50, return_sequences=True))
    # model.add(GRU(50, return_sequences=False))
    #model.add(Dense(nodes1, activation='tanh', activity_regularizer='L2',input_shape=(3208,)))
...
experimento="LOMOS_Agilent_entradas_{}_GRU_{}_dense2_{}_clases_{}_loss_{}_lr_{}_algoritmo_{}".format(slice_str,n_nodes1,n_nodes2,numero_clases,lossfunction,factor_aprendizaje,algoritmo)
