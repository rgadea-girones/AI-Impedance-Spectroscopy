    ...
    def __init__(self,read=False):
        ...
        if (read==True):
            ...
            self.def_cfg= {'f_inicial':{'value':10, 'limits':[10.0,100.0E6],'type':'float'},
                            ...
                            'modelo':{'value':0, 'limits':[0,3],'type':'int'},       
                            ...
                            #'direccion_redpitaya':"158.42.33.88",                            
                            #'direccion_redpitaya':"169.254.102.167",
                            # 'direccion_redpitaya':"192.168.128.1",
                            'direccion_redpitaya':"169.254.58.98",
                            'sujetos': "0-0",
